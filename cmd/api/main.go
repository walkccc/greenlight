...
func main() {
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "49c9efa882af47", "SMTP username")
	flag.StringVar(&cfg.smtp.password, "smtp-password", "aa06078df64bbb", "SMTP password")
	flag.StringVar(
		&cfg.smtp.sender,
		"smtp-sender",
