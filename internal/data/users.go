...
// AnonymousUser holds a pointer to a User struct representing an inactivated user with no ID, name,
// email, or password.
...
func ValidateUser(v *validator.Validator, user *User) {
	...
	// If the password hash is ever nil, it indicates a logic error in our codebase, most likely
	// because we forgot to set a password for the user. While this is a useful sanity check, it's
	// not an issue with the data provided by the client. Instead of adding an error to the
	// validation map, we raise a panic to handle this exceptional situation.
